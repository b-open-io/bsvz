...
test "go direct script rows: size parity" {
    ...
    const size_rows = [_]struct {
        ...
        .{ .name = "size of one is one byte", .value = 1, .locking_hex = "825187" },
        .{ .name = "size of 127 is one byte", .value = 127, .locking_hex = "825187" },
        .{ .name = "size of 128 is two bytes", .value = 128, .locking_hex = "825287" },
        .{ .name = "size of 32767 is two bytes", .value = 32_767, .locking_hex = "825287" },
        .{ .name = "size of 32768 is three bytes", .value = 32_768, .locking_hex = "825387" },
        .{ .name = "size of 8388607 is three bytes", .value = 8_388_607, .locking_hex = "825387" },
        .{ .name = "size of 8388608 is four bytes", .value = 8_388_608, .locking_hex = "825487" },
        .{ .name = "size of 2147483647 is four bytes", .value = 2_147_483_647, .locking_hex = "825487" },
        .{ .name = "size of 2147483648 is five bytes", .value = 2_147_483_648, .locking_hex = "825587" },
        .{ .name = "size of 549755813887 is five bytes", .value = 549_755_813_887, .locking_hex = "825587" },
        .{ .name = "size of 549755813888 is six bytes", .value = 549_755_813_888, .locking_hex = "825687" },
        .{ .name = "size of int64 max is eight bytes", .value = 9_223_372_036_854_775_807, .locking_hex = "825887" },
        .{ .name = "size of negative one is one byte", .value = -1, .locking_hex = "825187" },
        .{ .name = "size of negative 127 is one byte", .value = -127, .locking_hex = "825187" },
        .{ .name = "size of negative 128 is two bytes", .value = -128, .locking_hex = "825287" },
        .{ .name = "size of negative 32767 is two bytes", .value = -32_767, .locking_hex = "825287" },
        .{ .name = "size of negative 32768 is three bytes", .value = -32_768, .locking_hex = "825387" },
        .{ .name = "size of negative 8388607 is three bytes", .value = -8_388_607, .locking_hex = "825387" },
        .{ .name = "size of negative 8388608 is four bytes", .value = -8_388_608, .locking_hex = "825487" },
        .{ .name = "size of negative 2147483647 is four bytes", .value = -2_147_483_647, .locking_hex = "825487" },
        .{ .name = "size of negative 2147483648 is five bytes", .value = -2_147_483_648, .locking_hex = "825587" },
        .{ .name = "size of negative 549755813887 is five bytes", .value = -549_755_813_887, .locking_hex = "825587" },
        .{ .name = "size of negative 549755813888 is six bytes", .value = -549_755_813_888, .locking_hex = "825687" },
        .{ .name = "size of negative int64 max is eight bytes", .value = -9_223_372_036_854_775_807, .locking_hex = "825887" },
    };
...
test "go direct script rows: boolean and minmaxwithin parity" {
    ...
    try runRows(allocator, bsvz.script.engine.ExecutionFlags.legacyReference(), &[_]GoRow{
        ...
        .{ .name = "not over one becomes zero", .unlocking_hex = "5191", .locking_hex = "0087", .expected = .{ .success = true } },
        .{ .row = 224, .name = "not over eleven becomes zero", .unlocking_hex = "5b91", .locking_hex = "0087", .expected = .{ .success = true } },
        .{ .row = 225, .name = "zeronotequal over zero becomes zero", .unlocking_hex = "0092", .locking_hex = "0087", .expected = .{ .success = true } },
        .{ .name = "zeronotequal over one stays one", .unlocking_hex = "5192", .locking_hex = "5187", .expected = .{ .success = true } },
        .{ .row = 227, .name = "zeronotequal over eleven stays one", .unlocking_hex = "5b92", .locking_hex = "5187", .expected = .{ .success = true } },
        .{ .row = 228, .name = "zeronotequal over negative one stays one", .unlocking_hex = "4f92", .locking_hex = "5187", .expected = .{ .success = true } },
        .{ .row = 229, .name = "booland with true and true stays true", .unlocking_hex = "51519a", .locking_hex = "61", .expected = .{ .success = true } },
        .{ .row = 230, .name = "booland with true and false becomes true after not", .unlocking_hex = "51009a", .locking_hex = "91", .expected = .{ .success = true } },
        .{ .row = 231, .name = "booland with false and true becomes true after not", .unlocking_hex = "00519a", .locking_hex = "91", .expected = .{ .success = true } },
        .{ .name = "booland with false and false becomes true after not", .unlocking_hex = "00009a", .locking_hex = "91", .expected = .{ .success = true } },
        .{ .row = 233, .name = "booland with sixteen and seventeen stays true", .unlocking_hex = "6001119a", .locking_hex = "61", .expected = .{ .success = true } },
        .{ .row = 234, .name = "boolor with true and true stays true", .unlocking_hex = "51519b", .locking_hex = "61", .expected = .{ .success = true } },
        .{ .row = 235, .name = "boolor with true and false stays true", .unlocking_hex = "51009b", .locking_hex = "61", .expected = .{ .success = true } },
        .{ .name = "boolor with false and true stays true", .unlocking_hex = "00519b", .locking_hex = "61", .expected = .{ .success = true } },
        .{ .row = 237, .name = "boolor with false and false becomes true after not", .unlocking_hex = "00009b", .locking_hex = "91", .expected = .{ .success = true } },
        .{ .row = 238, .name = "boolor with sixteen and seventeen stays true", .unlocking_hex = "6001119b", .locking_hex = "61", .expected = .{ .success = true } },
        .{ .row = 271, .name = "within includes lower bound and excludes upper bound", .unlocking_hex = "000051", .locking_hex = "a5", .expected = .{ .success = true } },
        .{ .row = 272, .name = "within rejects upper bound and not makes it true", .unlocking_hex = "510051", .locking_hex = "a591", .expected = .{ .success = true } },
        .{ .row = 273, .name = "within accepts zero inside full int32 range", .unlocking_hex = within_315_hex, .locking_hex = "a5", .expected = .{ .success = true } },
        .{ .row = 274, .name = "within accepts negative one inside negative hundred to positive hundred", .unlocking_hex = within_316_hex, .locking_hex = "a5", .expected = .{ .success = true } },
        .{ .row = 275, .name = "within accepts eleven inside negative hundred to positive hundred", .unlocking_hex = within_317_hex, .locking_hex = "a5", .expected = .{ .success = true } },
        .{ .row = 276, .name = "within rejects very negative value and not makes it true", .unlocking_hex = within_318_hex, .locking_hex = "a591", .expected = .{ .success = true } },
        .{ .row = 277, .name = "within rejects very positive value and not makes it true", .unlocking_hex = within_319_hex, .locking_hex = "a591", .expected = .{ .success = true } },
...
test "go direct script rows: comparison and minmax exact rows" {
    ...
    try runRows(allocator, flags, &[_]GoRow{
        .{ .row = 239, .name = "numequal matches add-chain result", .unlocking_hex = add_chain, .locking_hex = eq_lock, .expected = .{ .success = true } },
        .{ .row = 240, .name = "numequalverify matches add-chain result", .unlocking_hex = add_chain, .locking_hex = eqverify_lock, .expected = .{ .success = true } },
        .{ .row = 241, .name = "numnotequal not over equal values becomes true", .unlocking_hex = add_chain, .locking_hex = notequal_not_lock, .expected = .{ .success = true } },
        .{ .row = 242, .name = "numnotequal over unequal values stays true", .unlocking_hex = "5f5a510193", .locking_hex = notequal_lock, .expected = .{ .success = true } },
        .{ .row = 243, .name = "lessthan not over greater values becomes true", .unlocking_hex = "5b5a", .locking_hex = lt_not_lock, .expected = .{ .success = true } },
        .{ .name = "lessthan not over equal values becomes true", .unlocking_hex = "5454", .locking_hex = lt_not_lock, .expected = .{ .success = true } },
        .{ .row = 245, .name = "lessthan over ascending values stays true", .unlocking_hex = "5a5b", .locking_hex = lt_lock, .expected = .{ .success = true } },
        .{ .row = 246, .name = "lessthan over negative and positive stays true", .unlocking_hex = neg11_11, .locking_hex = lt_lock, .expected = .{ .success = true } },
        .{ .row = 247, .name = "lessthan over negative ascending values stays true", .unlocking_hex = neg11_neg10, .locking_hex = lt_lock, .expected = .{ .success = true } },
        ...
        .{ .row = 303, .name = "lessthanorequal over negative and positive stays true", .unlocking_hex = neg11_11, .locking_hex = lte_lock, .expected = .{ .success = true } },
        .{ .row = 304, .name = "lessthanorequal over negative ascending stays true", .unlocking_hex = neg11_neg10, .locking_hex = lte_lock, .expected = .{ .success = true } },
        .{ .row = 305, .name = "greaterthanorequal over descending stays true", .unlocking_hex = "5b5a", .locking_hex = gte_lock, .expected = .{ .success = true } },
        .{ .row = 306, .name = "greaterthanorequal over equal values stays true", .unlocking_hex = "5454", .locking_hex = gte_lock, .expected = .{ .success = true } },
        .{ .row = 307, .name = "greaterthanorequal not over ascending becomes true", .unlocking_hex = "5a5b", .locking_hex = gte_not_lock, .expected = .{ .success = true } },
        .{ .row = 308, .name = "greaterthanorequal not over negative and positive becomes true", .unlocking_hex = neg11_11, .locking_hex = gte_not_lock, .expected = .{ .success = true } },
        .{ .row = 309, .name = "greaterthanorequal not over negative ascending becomes true", .unlocking_hex = neg11_neg10, .locking_hex = gte_not_lock, .expected = .{ .success = true } },
        .{ .row = 310, .name = "min of one and zero is zero", .unlocking_hex = "5100", .locking_hex = min_zero_eq_lock, .expected = .{ .success = true } },
        .{ .row = 311, .name = "min of zero and one is zero", .unlocking_hex = "0051", .locking_hex = min_zero_eq_lock, .expected = .{ .success = true } },
        .{ .row = 312, .name = "min of negative one and zero is negative one", .unlocking_hex = "4f00", .locking_hex = min_negone_eq_lock, .expected = .{ .success = true } },
        .{ .row = 313, .name = "min of zero and negative max int32 is negative max int32", .unlocking_hex = zero_negmax, .locking_hex = min_negmax_eq_lock, .expected = .{ .success = true } },
        .{ .row = 314, .name = "max of int32 max and zero is int32 max", .unlocking_hex = maxi32_zero, .locking_hex = max_maxi32_eq_lock, .expected = .{ .success = true } },
        .{ .row = 315, .name = "max of zero and hundred is hundred", .unlocking_hex = zero_hundred, .locking_hex = max_100_eq_lock, .expected = .{ .success = true } },
        .{ .row = 316, .name = "max of negative hundred and zero is zero", .unlocking_hex = neghundred_zero, .locking_hex = max_zero_eq_lock, .expected = .{ .success = true } },
        .{ .row = 317, .name = "max of zero and negative max int32 is zero", .unlocking_hex = zero_negmax, .locking_hex = max_zero_eq_lock, .expected = .{ .success = true } },
...
test "go direct script rows: boolean underflow parity" {
    ...
    try runRows(allocator, bsvz.script.engine.ExecutionFlags.legacyReference(), &[_]GoRow{
        .{ .name = "negate underflows with empty stack", .unlocking_hex = "61", .locking_hex = "8f51", .expected = .{ .err = error.StackUnderflow } },
        .{ .name = "abs underflows with empty stack", .unlocking_hex = "61", .locking_hex = "9051", .expected = .{ .err = error.StackUnderflow } },
        .{ .name = "not underflows with empty stack", .unlocking_hex = "", .locking_hex = "91", .expected = .{ .err = error.StackUnderflow } },
        .{ .name = "zeronotequal underflows with empty stack", .unlocking_hex = "", .locking_hex = "92", .expected = .{ .err = error.StackUnderflow } },
        .{ .name = "add underflows with one stack item", .unlocking_hex = "51", .locking_hex = "93", .expected = .{ .err = error.StackUnderflow } },
        .{ .name = "sub underflows with one stack item", .unlocking_hex = "51", .locking_hex = "94", .expected = .{ .err = error.StackUnderflow } },
        .{ .name = "booland underflows with one stack item", .unlocking_hex = "51", .locking_hex = "9a", .expected = .{ .err = error.StackUnderflow } },
        .{ .name = "boolor underflows with one stack item", .unlocking_hex = "51", .locking_hex = "9b", .expected = .{ .err = error.StackUnderflow } },
        .{ .name = "numequal underflows with one stack item", .unlocking_hex = "51", .locking_hex = "9c", .expected = .{ .err = error.StackUnderflow } },
        .{ .name = "numequalverify underflows with one stack item", .unlocking_hex = "51", .locking_hex = "9d51", .expected = .{ .err = error.StackUnderflow } },
    });
}
...
test "go direct script rows: compact boolean and arithmetic result shapes" {
    ...
    try runRows(allocator, bsvz.script.engine.ExecutionFlags.legacyReference(), &[_]GoRow{
        .{ .name = "abs over negative one leaves a truthy result", .unlocking_hex = "4f90", .locking_hex = "", .expected = .{ .success = true } },
        .{ .name = "not over zero leaves a truthy result", .unlocking_hex = "0091", .locking_hex = "", .expected = .{ .success = true } },
        .{ .name = "zeronotequal over negative one leaves a truthy result", .unlocking_hex = "4f92", .locking_hex = "", .expected = .{ .success = true } },
        .{ .name = "add over one and zero leaves a truthy result", .unlocking_hex = "510093", .locking_hex = "", .expected = .{ .success = true } },
...
test "go direct script rows: exact raw numeric encoding boundaries" {
    const allocator = std.testing.allocator;

    try runRows(allocator, bsvz.script.engine.ExecutionFlags.legacyReference(), &[_]GoRow{
        .{ .name = "raw zero byte reports size zero", .unlocking_hex = "00", .locking_hex = "820087", .expected = .{ .success = true } },
        .{ .name = "raw 0x81 compares equal to negative one", .unlocking_hex = "0181", .locking_hex = "4f87", .expected = .{ .success = true } },
        .{ .name = "raw 0x01 compares equal to one", .unlocking_hex = "0101", .locking_hex = "5187", .expected = .{ .success = true } },
        .{ .name = "raw 0x02 compares equal to two", .unlocking_hex = "0102", .locking_hex = "5287", .expected = .{ .success = true } },
        .{ .name = "raw 0x03 compares equal to three", .unlocking_hex = "0103", .locking_hex = "5387", .expected = .{ .success = true } },
        .{ .name = "raw 0x8000 compares numerically equal to 128", .unlocking_hex = "028000", .locking_hex = "0280009c", .expected = .{ .success = true } },
        .{ .name = "raw 0x00 compares numerically equal to zero", .unlocking_hex = "0100", .locking_hex = "009c", .expected = .{ .success = true } },
        .{ .name = "raw negative zero compares numerically equal to zero", .unlocking_hex = "0180", .locking_hex = "009c", .expected = .{ .success = true } },
        .{ .name = "raw non-minimal negative zero compares numerically equal to zero", .unlocking_hex = "020080", .locking_hex = "009c", .expected = .{ .success = true } },
        .{ .name = "raw non-minimal five compares numerically equal to five", .unlocking_hex = "020500", .locking_hex = "559c", .expected = .{ .success = true } },
        .{ .name = "raw non-minimal zero compares numerically equal to 0xffff", .unlocking_hex = "03ff7f80", .locking_hex = "02ffff9c", .expected = .{ .success = true } },
        .{ .name = "raw non-minimal positive compares numerically equal to 0xff7f", .unlocking_hex = "03ff7f00", .locking_hex = "02ff7f9c", .expected = .{ .success = true } },
        .{ .name = "raw wider non-minimal zero compares numerically equal to 0xffffff", .unlocking_hex = "04ffff7f80", .locking_hex = "03ffffff9c", .expected = .{ .success = true } },
        .{ .name = "raw wider non-minimal positive compares numerically equal to 0xffff7f", .unlocking_hex = "04ffff7f00", .locking_hex = "03ffff7f9c", .expected = .{ .success = true } },
    });
}
