...
test "go direct stack rows: safe underflow subset" {
    ...
    try runRows(allocator, &[_]GoRow{
        ...
        .{
            .name = "fromaltstack underflows on empty alt stack",
            .unlocking_hex = "51",
            .locking_hex = "6c",
            .expected = .{ .err = error.AltStackUnderflow },
        },
        .{
            .name = "ifdup underflows even with a trailing push",
            .unlocking_hex = "61",
            .locking_hex = "7351",
            .expected = .{ .err = error.StackUnderflow },
        },
        .{
            .name = "drop underflows even with a trailing push",
            .unlocking_hex = "61",
            .locking_hex = "7551",
            .expected = .{ .err = error.StackUnderflow },
        },
        .{
            .name = "dup underflows even with a trailing push",
            .unlocking_hex = "61",
            .locking_hex = "7651",
            .expected = .{ .err = error.StackUnderflow },
        },
        ...
        .{
            .name = "twoover on three items errors",
            .unlocking_hex = "515151",
            .locking_hex = "70",
            .expected = .{ .err = error.StackUnderflow },
        },
        .{
            .name = "tworot on five items errors",
            .unlocking_hex = "5151515151",
            .locking_hex = "71",
            .expected = .{ .err = error.StackUnderflow },
        },
        .{
            .name = "twoswap on three items errors",
            .unlocking_hex = "515151",
            .locking_hex = "72",
            .expected = .{ .err = error.StackUnderflow },
        },
        .{
            .name = "swap requires two stack items",
            .unlocking_hex = "51",
            .locking_hex = "7c",
            .expected = .{ .err = error.StackUnderflow },
        },
        ...
        .{
            .name = "over requires two stack items even with an adjacent exact-corpus collision elsewhere",
            .unlocking_hex = "51",
            .locking_hex = "78",
            .expected = .{ .err = error.StackUnderflow },
        },
