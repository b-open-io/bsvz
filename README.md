...
- the script interpreter now combines 1,371 unique exact Go row references across the dedicated lanes, including the direct exact-corpus lane sourced from `script_tests.json`; exact Go-row coverage is now 91.5% of the 1,499-row corpus, and the suite also keeps a 1,099-row filtered bulk-corpus lane plus focused filtered sigcheck and multisig reference lanes for mixed policy/result-shape coverage
